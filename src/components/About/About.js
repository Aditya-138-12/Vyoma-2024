    ...
    >
      <div className={classes.about}>
        <div className={classes.details}>
          ...
          <h2 className={classes.heading1}>VYOMA 24</h2>
          <p className={classes.para}>
            Its the annual national-level techno­managerial ­cultural
            extravaganza of the SJC Institute of Technology. VYOMA invites
          ...
          <p className={classes.para}>
            ...
            titanic prize money sum of above half a million rupees to make VYOMA
