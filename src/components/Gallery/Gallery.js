    ...
    >
      <Background className={classes.eventBox}>
        ...
        <div className={classes.headingBox}>
          <h3 className={classes.heading}>VYOMA - Corridor</h3>
          <p className={classes.para}>
            The Fest includes a variety of activities, including technical,
            non-technical, and project contests. The event is
